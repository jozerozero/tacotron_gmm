...
def synthesize(args, hparams, taco_checkpoint, wave_checkpoint, sentences):
	...
	sleep(0.5)
	griffin_synthesis(wavenet_in_dir)
	exit()
...
def main():
	accepted_modes = ['eval', 'synthesis', 'live', 'demo']
	...
	parser.add_argument('--mode', default='demo', help='mode of run: can be one of {}'.format(accepted_modes))
