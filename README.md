...
## WARNING!! always run python infolog.py first to check whether can ouput unicode
## CUDA_VISIBLE_DEVICES=0,1,2,3 python train.py --model='Tacotron-2'
## CUDA_VISIBLE_DEVICES=4,5,6,7 python train.py --model='WaveNet'
